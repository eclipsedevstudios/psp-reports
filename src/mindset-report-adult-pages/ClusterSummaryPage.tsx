...
import { AdultSurveyResponse } from '../models/surveyResponse';
import { percentileInterpretationAdult } from '../constants/clusters_adult';
...
interface ClusterSummaryPageProps {
  ...
  surveyResponse: AdultSurveyResponse;
  pageNum: number;
}
...
const ClusterSummaryPage = ({
  ...
  const interpretation = percentileInterpretationAdult.filter(obj => obj.name === clusterName && obj.language === language && percentile >= obj.minPercentile && percentile <= obj.maxPercentile)[0];
