...
const testingSampleStrings: { [key in Language]: ReactNode } = {
  [Language.English]: <>
    ...
    <p>
      ...
      athletes at all levels of sport. From
      recreational to elite national team
      players. Sports represented in our
      sample include: baseball; basketball;
      boxing; curling; cycling, football;
      golf; gymnastics; hockey; lacrosse;
      mixed martial arts; running; rowing;
  ...
  [Language.Spanish]: <>
    ...
    <p>
      ...
      recreativos hasta jugadores de élite de equipos nacionales.
      Los deportes representados en nuestra
      muestra incluyen: béisbol; baloncesto;
      boxeo; curling; ciclismo, fútbol;
      golf; gimnasia; hockey; lacrosse;
      artes marciales mixtas; correr; remo;
      fútbol; softbol; natación;
