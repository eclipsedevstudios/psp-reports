...
import CoverPage from './mindset-report-youth-golf-pages/CoverPage';
...
import WrapUpPage from './mindset-report-youth-golf-pages/WrapUpPage';
...
function MindsetReportYouthGolf() {
...
export default MindsetReportYouthGolf;